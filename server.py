...
class Handler(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path=='/admin-login':
            ...
            body=f'''<header><a href="/" class="admin-brand" aria-label="100% Focus Club home"><img class="admin-wordmark" src="/100_Focus_Club_Wordmark_Transparent.png" alt="100% Focus Club"><img class="admin-emblem" src="/100_Focus_Club_Emblem_Transparent.png" alt=""></a></header><main><div class="card"><h1>Admin Login</h1><p>{err}</p><form method="post" action="/admin-login"><p><input name="username" placeholder="Username" required></p><p><input type="password" name="password" placeholder="Password" required></p><button class="btn">Sign in</button></form></div></main>'''
